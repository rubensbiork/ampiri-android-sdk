...
* support-v4, v25.0.0
* joor, v0.9.6
* **Recommended** Google Play Services 9.6.1
...
dependencies {
  ...
  compile(name: 'ampiri-sdk-mediation-chartboost', version:'3.3.0', ext: 'aar')
...
* `ampiri-sdk-mediation-admob` [Google Mobile Ads](https://developers.google.com/admob/android/quick-start) v9.6.1, API 9: Android 2.3 (Gingerbread)
